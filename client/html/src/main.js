...
import { CoHome, BiCameraVideo, BiGearFill, LaMapSolid, BiPatchQuestionFill, FaEdit, FaTrash } from "oh-vue-icons/icons"
...
const store =  createStore({
  ...
  actions: {
    async loadConfig({ commit }) {
      try {
        const response = await fetch(`https://${GetParentResourceName()}/GetConfigjson`, {
          method: "POST",
    ...
    async saveConfig({ state }) {
      try {
        await fetch(`https://${GetParentResourceName()}/setConfigjson`, {
          method: "POST",
          headers: { "Content-Type": "application/json" },
...
addIcons(CoHome, BiCameraVideo, BiGearFill, LaMapSolid, BiPatchQuestionFill, FaEdit, FaTrash)
